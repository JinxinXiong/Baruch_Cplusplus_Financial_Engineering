...
namespace DevonKaberna
{
	namespace CAD
	{
		Point::Point() : Shape(), m_x(0), m_y(0) { cout << "Point created" << endl; } // Default constructor

		Point::Point(double x_value, double y_value) : Shape(), m_x(x_value), m_y(y_value) { cout << "Point created" << endl; }	// Overload constructor that initialize with x and y value

		Point::Point(const Point& source) : Shape(source), m_x(source.m_x), m_y(source.m_y) { cout << "Point created" << endl; }	// Copy constructor
		...
		Point::~Point() { cout << "point destroyed" << endl; } // Destructor
