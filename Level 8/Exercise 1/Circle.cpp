...
namespace DevonKaberna
{
	namespace CAD
	{
		...
		Circle::Circle() : Shape(), m_centre_point(0.0, 0.0), m_radius(0.0) { cout << "Circle created" << endl; }	 // Default constructor
		...
		Circle::~Circle() { cout << "circle destroyed" << endl; }	// Destructor
